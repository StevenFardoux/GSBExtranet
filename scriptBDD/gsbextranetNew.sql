...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 29 sep. 2022 à 14:08
...
INSERT INTO `medecin` (`id`, `nom`, `prenom`, `mail`, `dateNaissance`, `motDePasse`, `dateCreation`, `rpps`, `token`, `dateDiplome`, `dateConsentement`, `valideCompte`) VALUES
(1, 'bob', 'alice', 'test@test.fr', NULL, 'Azerty@123456789', '2022-09-15 16:44:14', NULL, '4444', NULL, '2022-09-15', 1),
(3, 'admin', 'alice', 'admin@admin.fr', NULL, 'Azerty@123456789', '2022-09-22 16:02:10', NULL, NULL, NULL, '2022-09-22', 1);
